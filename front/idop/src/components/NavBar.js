...
export const NavBar = props => {
    ...
    return (
        ...
        <div class="nav-wrapper">
          ...
          {/*  <div class="nav-items">
               <img src="add.PNG" class="icon" alt="" onClick={() => { props.setnewtask(!props.newtask);  }} /> <p>ADD PROCRASTINATION</p>
                <img src="home.PNG" class="icon" alt=""/> 
                <img src="user.png" class="icon" alt="" onClick={() => { props.setaccount(!props.account);  }} /><p>ACCOUNT</p>
